...
class TranscriptionEngine:
    """
    Transcription engine that loads and manages ASR models.

    Note: Singleton pattern removed to support multiple language instances.
    Use get_transcription_engine() in basic_server.py for caching.
    """
