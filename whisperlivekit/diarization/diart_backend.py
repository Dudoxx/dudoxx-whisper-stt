...
class DiartDiarization:
    def __init__(
        ...
        # Load models with HuggingFace token for gated models
        # Token is read from HF_TOKEN environment variable
        segmentation_model = m.SegmentationModel.from_pretrained(
            segmentation_model_name, use_hf_token=True
        )
        embedding_model = m.EmbeddingModel.from_pretrained(
            embedding_model_name, use_hf_token=True
        )
