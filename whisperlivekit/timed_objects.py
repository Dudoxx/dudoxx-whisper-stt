...
class TimedText(Timed):
    ...
    confidence: Optional[float] = None  # Word/segment confidence score (0.0 - 1.0)
...
class Segment(TimedText):
    ...
    def from_tokens(
        ...
        if is_silence:
            ...
            # Calculate average confidence from tokens that have confidence scores
            confidences = [
                t.confidence
                for t in tokens
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.confidence is not None:
            _dict["confidence"] = round(self.confidence, 3)
        return _dict
...
class FrontData:
    ...
    is_final: bool = False  # Like Deepgram's is_final flag
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.language_confidence is not None:
            _dict["language_confidence"] = round(self.language_confidence, 3)
        if self.audio_duration > 0:
            _dict["audio_duration"] = round(self.audio_duration, 2)
        if self.words:
